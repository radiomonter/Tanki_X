namespace UnityStandardAssets.ImageEffects
{
    ...
    [ExecuteInEditMode, RequireComponent(typeof(Camera)), AddComponentMenu("Image Effects/Other/Antialiasing")]
    public class Antialiasing : PostEffectsBase
    {
        ...
        {
            Material materialFXAAII = null;
            switch (this.mode)
            {
                case AAMode.FXAA2:
                    materialFXAAII = this.materialFXAAII;
                    break;

                case AAMode.FXAA3Console:
                    materialFXAAII = this.materialFXAAIII;
                    break;

                case AAMode.FXAA1PresetA:
                    materialFXAAII = this.materialFXAAPreset2;
                    break;

                case AAMode.FXAA1PresetB:
                    materialFXAAII = this.materialFXAAPreset3;
                    break;

                case AAMode.NFAA:
                    materialFXAAII = this.nfaa;
                    break;

                case AAMode.SSAA:
                    materialFXAAII = this.ssaa;
                    break;

                case AAMode.DLAA:
                    materialFXAAII = this.dlaa;
                    break;
