namespace UnityEngine.PostProcessing
{
    ...
    public class EyeAdaptationModel : PostProcessingModel
    {
        ...
        public struct Settings
        {
            ...
            [Range(-16f, -1f), Tooltip("Lower bound for the brightness range of the generated histogram (in EV). The bigger the spread between min & max, the lower the precision will be.")]
            public int logMin;
            [Range(1f, 16f), Tooltip("Upper bound for the brightness range of the generated histogram (in EV). The bigger the spread between min & max, the lower the precision will be.")]
            public int logMax;
            public static EyeAdaptationModel.Settings defaultSettings =>
                new EyeAdaptationModel.Settings { 
                    lowPercent=45f,
                    highPercent=95f,
                    minLuminance=-5f,
                    maxLuminance=1f,
