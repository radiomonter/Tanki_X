namespace Tanks.Lobby.ClientPaymentGUI.Impl
{
    ...
    public class ShopXCrystalsSystem : ECSSystem
    {
        ...
        {
            base.ScheduleEvent<CheckGiftsEvent>(user);
        }
        ...
        {
            dialogs.component.Get<ShopDialogs>().Cancel();
        }
        ...
        {
            base.ScheduleEvent<GoToPaymentRequestEvent>(user);
            base.ScheduleEvent<ResetPreviewEvent>(user);
        }
        ...
        {
            base.ScheduleEvent<ResetPreviewEvent>(containersUi);
        }
        ...
        public class XCrystalPack : ShopXCrystalsSystem.PackNode
        {
        }
    }
}
