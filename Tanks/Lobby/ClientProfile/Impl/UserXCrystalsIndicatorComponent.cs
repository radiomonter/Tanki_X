namespace Tanks.Lobby.ClientProfile.Impl
{
    ...
    public class UserXCrystalsIndicatorComponent : BehaviourComponent
    {
        ...
        {
            this.moneyText.text = this.money.ToStringSeparatedByThousands();
        }
        ...
        private sealed class <ShowAnimation>c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
        {
            ...
            internal UserXCrystalsIndicatorComponent $this;
            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    case 0:
                        ...
                        this.<delay>__0 = (this.<moneyDiff>__0 == 0f) ? 0.01f : (this.<setMoneyAnimationTime>__0 / Mathf.Abs(this.<moneyDiff>__0));
